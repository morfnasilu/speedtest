...
@property (nonatomic, copy) NSData *localData;
...
@property (nonatomic, copy) void (^progressAction)(NSInteger completedChunkSize, NSInteger totalSize, NSInteger finishedSize, CGFloat finishedPercent);
